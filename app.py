...
def main():
    ...
    st.header("Chat AI HSC Software Tutor :books:")
    ...
    dir_path = "hscsoftwarepdf"

    # Get a list of all files in the directory
    files = os.listdir(dir_path)

    # List to store file contents as BytesIO objects
    file_contents = []
    ...
    for file in files:
        ...
        # Create BytesIO object from file contents
        file_io = BytesIO(data)
        
        # Add BytesIO object to the list
        file_contents.append(file_io)

    # get pdf text
    raw_text = get_pdf_text(file_contents)
